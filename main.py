...
# ==========================================
# 📥 DOWNLOAD & UPLOAD LOGIC (With MongoDB)
# ==========================================
async def process_video(client, original_message, vid_title, m3u8_url, yt_thumb, yt_duration):
    ...
    if cached_video:
        await status.edit_text(f"⚡ **Video Found in Database! Sending Instantly...**")
        # Direct file_id se bhej rahe hain, "Forwarded from" nahi likha aayega
            ...
            if r.status_code == 200:
                ...
                for index, vid in enumerate(franchise_videos):
                    ...
                    if m3u8_link:
                        ...
                        # 🛡️ 5 SECOND REST RULE WAPAS DAALA HAI (Anti-Ban ke liye)
